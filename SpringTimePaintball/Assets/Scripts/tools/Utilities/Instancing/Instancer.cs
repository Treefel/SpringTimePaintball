...
public class Instancer : ScriptableObject
{
    ...
    public void InstanceFromObjectList (GameObjectList collection)
    {
        Transform curObj = collection.gameObjects[indexer.Value].transform;
        Instantiate(prefab, curObj.position, curObj.rotation);
